...
def _build_revision_messages(
    ...
    *,
    ...
    directive = (
        ...
        "ground every legal fact in the context. Keep the revision focused — fix "
        "the flagged backbone without padding — but PRESERVE the draft's balanced "
        "analysis: where it correctly presented BOTH outcomes (e.g. high-risk AND "
        "the conditions under which it is NOT high-risk, or arguments for and "
        "against), keep both; do NOT collapse a nuanced 'it depends' into a "
        "one-sided conclusion, and do NOT drop a valid secondary branch (e.g. "
        "general-purpose-AI-model obligations, an Annex III check) merely to be "
        "concise. Trim redundancy, not valid alternatives.\n"
